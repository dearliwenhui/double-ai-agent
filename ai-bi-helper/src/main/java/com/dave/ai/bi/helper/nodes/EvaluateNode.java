...
public class EvaluateNode implements NodeAction {
    ...
    public EvaluateNode(ChatClient.Builder chatClientBuilder, SchemaRetrievalPipeline schemaRetrievalPipeline) {
    ...
    public Map<String, Object> apply(OverAllState state) throws Exception {
        ...
        String retrievalContext = state.value("retrievalContext", "");
        ...
        if (retrievalContext == null || retrievalContext.isBlank()) {
            SchemaRetrievalContext context = schemaRetrievalPipeline.retrieve(userInput);
            retrievalContext = context.assembledContext();
        }
        String systemPrompt = ("""
                # 角色
                ...
                以下是已经筛选后的 schema 上下文，请严格基于这些信息审核 SQL 是否存在字段、表、关联关系幻觉：
